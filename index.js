...
function displayProductCard(cardPreview, cardName, cardBrand, cardPrice){
    ...
    thumbnail.src=cardPreview;
    productCard.appendChild(thumbnail);

    var description = document.createElement("h3");
    description.className = "description";
    description.innerText = cardName;
    productCard.appendChild(description);

    var brand = document.createElement("h4");
    brand.className = "brand";
    brand.innerText = cardBrand;
    productCard.appendChild(brand);

    var price = document.createElement("h5");
    price.className = "price";
    price.innerText = "Rs "+cardPrice;
...
sectionHeading.innerText = "Clothing for Men and Women";
...
for( var i=0; i<5; i++){
    displayProductCard(productList[i].preview,productList[i].name,productList[i].brand,productList[i].price);
}

var sectionHeading2 = document.createElement("h2");
sectionHeading2.className = "section-title";
sectionHeading2.innerText = "Accessories for Men and Women";
mainContainer.appendChild(sectionHeading2);
